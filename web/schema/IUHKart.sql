...
ALTER TABLE "discount" ADD FOREIGN KEY ("vendor_id") REFERENCES "vendor" ("vendor_id");

ALTER TABLE "product" ADD FOREIGN KEY ("product_id") REFERENCES "discount" ("product_id");
