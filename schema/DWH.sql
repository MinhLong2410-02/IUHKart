CREATE TABLE "dim_product" (
  ...
  "category_id" int NOT NULL
    ...
    @@ -14,15 +16,17 @@ CREATE TABLE "fact_discount" (
...
CREATE TABLE "dim_vendor" (
  ...
  "address_id" int NOT NULL
    ...
    @@ -32,7 +36,8 @@ CREATE TABLE "dim_customer" (
...
CREATE TABLE "dim_customer" (
  ...
  "address_id" int NOT NULL
    ...
    @@ -54,6 +59,14 @@ CREATE TABLE "fact_order_product" (
...
CREATE TABLE "dim_category" (
  ...
  "category_name" varchar(255),
    ...
    @@ -110,9 +123,13 @@ ALTER TABLE "fact_discount" ADD FOREIGN KEY ("product_id") REFERENCES "dim_produ
...
ALTER TABLE "district" ADD FOREIGN KEY ("province_id") REFERENCES "province" ("province_id");
    ...
    @@ -122,4 +139,4 @@ ALTER TABLE "ward" ADD FOREIGN KEY ("province_id") REFERENCES "province" ("provi
